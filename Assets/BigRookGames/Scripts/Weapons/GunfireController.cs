...
namespace BigRookGames.Weapons
{
    public class GunfireController : MonoBehaviour
    {
        ...
        private const int left = 0; // 0 = left mouse button, 1 = right mouse button, 2 = middle mouse button
        ...
        private void Update()
        {
            ...
            if (Input.GetMouseButtonDown(left) && ((timeLastFired + shotDelay) <= Time.time))
            {
                FireWeapon();
            }
